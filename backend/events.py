...
from typetrace.config import BUFFER_SIZE, BUFFER_TIMEOUT, DEBUG, KeyEvent
from typetrace.db import write_to_database
from typetrace.devices import select_keyboards
...
def trace_keys() -> None:
    ...
    from typetrace.devices import managed_devices
