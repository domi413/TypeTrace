...
from typetrace.config import DB_NAME, PROJECT_VERSION, ExitCodes
...
def main() -> int:
    ...
    if args.debug:
        ...
        import typetrace.config

        typetrace.config.DEBUG = True
        from typetrace.logging_setup import setup_logging
    ...
    try:
        ...
        from typetrace.db import initialize_database

        initialize_database(db_path)
        from typetrace.events import trace_keys
